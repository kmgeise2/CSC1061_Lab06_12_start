// Note stoi() is string-to-integer
...
public:
    ...
    // column.
    static void PopulateGradebookFromRows(Gradebook& gradebook,
    ...
    static CourseGradebook MakeSampleGradebook() {
        ...
        rows.push_back({ "Student ID", "Homework 1", "Homework 2", "Midterm", "Homework 3", "Homework 4", "Course project", "Final exam" });
        ...
        rows.push_back({ "55555",      "73.5",       "76.5",       "64.5",    "71.5",        "77.5",       "87",            "63.5" });
    ...
    template <typename T>
    static void PrintVector(const vector<T>& vectorToPrint,
        ostream& output, string separator = ",") {
